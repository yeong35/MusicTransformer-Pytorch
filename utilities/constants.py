...
from third_party.midi_processor.processor import RANGE_NOTE_ON, RANGE_NOTE_OFF, RANGE_VEL, RANGE_TIME_SHIFT, DURATION, NOTE_CHANGE, START_PITCH, OCTAVE_RANGE, PITCH_RANGE, OCTAVE_RANGE_INTERVAL, PITCH_RANGE_INTERVAL
